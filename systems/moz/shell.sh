...
alias fetch_secrets='pushd $SEOMOZ_ROOT/roger && ansible-playbook -i dalmesos01, ansible/ansible-secrets-fetch.yml && popd'
alias push_secrets='pushd $SEOMOZ_ROOT/roger && ansible-playbook -i dalmesos01, ansible/ansible-secrets-push.yml && popd'
